...
special skills required to read on, although some notions on tests and Test
Driven Development (TDD) would be a plus.
...
(guess why ;) ). I'll write about the second part (storyBDD) in a future
article.
...
To keep good habits, in the next article we'll switch to the technical mode and
see some [phpspec](http://www.phpspec.net/)!
