...
so let's upgrade it to PHP 8.5!
...
to `SetList::PHP_84`, which will then make all the necessary upgrades from PHP 5.6 to 8.5,
...
I'm gonna be brief now, as after that, upgrading all the way to PHP 8.5,
